...
func WithHandler(h Handler) Option {
	return func(o *options) error {
		...
		// TODO: logger should be assigned outside the option
		// split UnsafeHandler and Handler as two different option
		// fields
		return WithUnsafeHandler(NewPanicHandler(h, o.Logger))(o)
	}
}
